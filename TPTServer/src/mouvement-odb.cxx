...
namespace odb
{
  ...
  struct access::object_traits_impl< ::Mouvement, id_mysql >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::Mouvement, id_mysql >::id_type
  access::object_traits_impl< ::Mouvement, id_mysql >::
  ...
  bool access::object_traits_impl< ::Mouvement, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    b[n].buffer_type = MYSQL_TYPE_STRING;
    b[n].buffer = i.application_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i.application_value.capacity ());
    b[n].length = &i.application_size;
    b[n].is_null = &i.application_null;
    n++;
  }
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      bool is_null (false);
      std::size_t size (0);
      std::size_t cap (i.application_value.capacity ());
      mysql::value_traits<
          ::std::string,
          mysql::id_string >::set_image (
        i.application_value,
        ...
        is_null,
        v);
      i.application_null = is_null;
      i.application_size = static_cast<unsigned long> (size);
      grew = grew || (cap != i.application_value.capacity ());
    }
  ...
  const char access::object_traits_impl< ::Mouvement, id_mysql >::erase_query_statement[] =
  "DELETE FROM `Mouvement`";

  const char access::object_traits_impl< ::Mouvement, id_mysql >::table_name[] =
  "`Mouvement`";
  ...
  access::object_traits_impl< ::Mouvement, id_mysql >::pointer_type
  access::object_traits_impl< ::Mouvement, id_mysql >::
  ...
  result< access::object_traits_impl< ::Mouvement, id_mysql >::object_type >
  access::object_traits_impl< ::Mouvement, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::Mouvement, id_mysql >::
